...
The  permissions we are interested in granting are listed below. Review the following table for a detailed description of the differences between `All` and `OwnedBy`. Both permissions can be used for a *Super Service Principal*.
